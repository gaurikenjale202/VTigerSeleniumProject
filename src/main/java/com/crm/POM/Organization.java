...
public class Organization {
	...
	private @FindBy(xpath = "//a[text() = 'Organizations']") WebElement organizationButton;

	private @FindBy(xpath = "//img[@title='Create Organization...']") WebElement newOrganization;

	private @FindBy(xpath = "//input[@name='accountname']") WebElement OrganizationName;

	private @FindBy(xpath = "//input[@accesskey='S']") WebElement saveButton;

	private @FindBy(xpath = "//span[@class='dvHeaderText']") WebElement verifyCreation;

	private @FindBy(xpath = "//select[@name='industry']") WebElement industries;

	private @FindBy(id = "dtlview_Industry") WebElement industriesVerfify;
	...
	public void createOrganization(String name) {
		...
		OrganizationName.sendKeys(name+util.generateRandomNumber(1000));
		saveButton.click();
	}
